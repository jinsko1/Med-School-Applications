...
DO_NOT_SHARE_TITLE_PATTERNS = (
    ...
    "active learning fit",
    "advanced academic work and humanism",
    ...
    "competency 2",
    "community identity",
    "diverse populations and central valley",
    "exposure to medicine",
    "family connection",
    "fictional character",
    "global health",
    "greatest generational challenge",
    ...
    "chicago and north chicago region",
    "leadership positions",
    "learning environment contribution",
    "lifelong learning",
    "mission alignment",
    "mission fit",
    ...
    "contribution to mcw",
    "new environment and community engagement",
    "pipeline programs",
    "pre-health advisor",
    "preparation for advanced study in medicine",
    "problem solving in team or pbl environment",
    "prime-",
    "prior admissions office interaction",
    "professionalism competencies",
    "protecting a vulnerable trait",
    "publications",
    "regional connection",
    "regional medical campus",
    "right thing versus rules",
...
GROUP_RULES: tuple[GroupRule, ...] = (
    ...
    GroupRule(
        ...
        ("challenge", "obstacle", "resilience", "adversit", "conflict", "ambiguity", "difficult", "feedback"),
        ("challenge",),
    ),
    GroupRule(
        "teamwork-leadership",
