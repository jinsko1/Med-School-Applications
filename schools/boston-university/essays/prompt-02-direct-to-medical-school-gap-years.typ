...
= Boston University Chobanian & Avedisian School of Medicine - Prompt 02
...
- Source: https://med.admit.org/secondary-essays/boston-university-school-of-medicine
- Local notes file: prompt-02.local.md

#section_label("Prompt text")
Are you expecting to go on to medical school directly after completing your undergraduate degree? If you took gap year(s), please use this space to explain what you have been doing prior to applying to medical school.

#section_label("Shared backbone files")
- typst/shared/gap-year.typ

#section_label("gap-year backbone")
