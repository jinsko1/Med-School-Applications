# Lewis Katz School of Medicine at Temple University Research Notes
...
## Prompt Strategy
- `Why Temple`: tie the school mission to your research-service throughline, then add two named programs or clinical/community sites before submission.
- `What Makes You Unique`: select the strongest matching activity and keep the reflection tied to medicine.
- `Campus Interest`: tie the school mission to your research-service throughline, then add two named programs or clinical/community sites before submission.
- `Current Year Plans`: give a concise timeline of research, clinical work, service, and application-year responsibilities.
- `COVID Impact`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
