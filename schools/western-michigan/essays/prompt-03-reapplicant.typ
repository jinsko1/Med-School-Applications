...
= Western Michigan University Homer Stryker M.D. School of Medicine - Prompt 03

#section_label("Prompt metadata")
- Title: Reapplicant
- Limit: 2000 characters
- Cycle used in this repo: 2024 archive on Admit.org
- Source: https://med.admit.org/secondary-essays/western-michigan-university
- Local notes file: prompt-03.local.md

#section_label("Prompt text")
WMed re-applicants only: Describe the changes to your application from previous cycles.
