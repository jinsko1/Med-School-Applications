# Loyola University Chicago Stritch School of Medicine Research Notes
...
- School context: Maywood, IL; cached accepted-student medians: GPA 3.87, MCAT 513.
- Current list note: Prompt set centers on Jesuit mission, social justice, service, disagreement, and professional challenge.
...
- Difference/belonging fit: draw from juvenile hall conversations, DEI committee listening, hospice communication beyond words, and reading fiction as practice inhabiting other perspectives.
...
## Prompt Strategy
- `Jesuit Mission Resonance`: select the strongest matching activity and keep the reflection tied to medicine.
...
- `Social Justice and Under-Resourced Communities`: lead with Restorative Partners, menstrual-product advocacy, hospice, or UTI/women's-health research depending on the wording.
- `Disagreeing with Feedback`: use a concrete moment of humility, then show the behavioral adjustment you made afterward.
- `Non-Academic Challenge or Conflict`: use a concrete moment of humility, then show the behavioral adjustment you made afterward.
- `Updates and Context`: select the strongest matching activity and keep the reflection tied to medicine.
- `Gaps, Delays, or Academic Missteps`: use a concrete moment of humility, then show the behavioral adjustment you made afterward.
- `If Out of Coursework for Two Years`: select the strongest matching activity and keep the reflection tied to medicine.
