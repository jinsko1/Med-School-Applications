# UC Davis School of Medicine Research Notes
...
## Prompt Strategy
- `Application Concerns`: select the strongest matching activity and keep the reflection tied to medicine.
- `Regional Connection`: select the strongest matching activity and keep the reflection tied to medicine.
- `UC Davis-Relevant Activities`: select the strongest matching activity and keep the reflection tied to medicine.
