...
= New York Medical College - Prompt 01

#section_label("Prompt metadata")
- Title: Family Connection
- Limit: No word limit
- Cycle used in this repo: 2024 archive on Admit.org
- Source: https://med.admit.org/secondary-essays/new-york-medical-college
- Local notes file: prompt-01.local.md

#section_label("Prompt text")
If you have family members with a connection to NYMC as alumni, faculty, or employees of the School of Medicine, indicate the relationship and applicable connection details.
