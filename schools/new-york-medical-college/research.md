# New York Medical College Research Notes
...
## Prompt Strategy
- `Family Connection`: select the strongest matching activity and keep the reflection tied to medicine.
- `Social Media Policy Explanation`: select the strongest matching activity and keep the reflection tied to medicine.
- `COVID Disruptions`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
- `Technical Standards Attestation`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
