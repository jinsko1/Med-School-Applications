# University of Miami Leonard M. Miller School of Medicine Research Notes
...
## Prompt Strategy
- `Why Miami`: tie the school mission to your research-service throughline, then add two named programs or clinical/community sites before submission.
- `Diverse Environments`: select the strongest matching activity and keep the reflection tied to medicine.
- `Values`: use ASI menstrual-product advocacy, lab training, Learning Assistant work, or BCSM Ambassador outreach as collaborative leadership.
