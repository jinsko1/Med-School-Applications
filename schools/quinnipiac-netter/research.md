# Frank H. Netter M.D. School of Medicine at Quinnipiac University Research Notes
...
## Prompt Strategy
- `Application Year Plan`: select the strongest matching activity and keep the reflection tied to medicine.
- `Specialty Interests and Future Career`: give a concise timeline of research, clinical work, service, and application-year responsibilities.
- `Lived Experiences and Patient Care`: select the strongest matching activity and keep the reflection tied to medicine.
- `Beyond Your Capabilities`: select the strongest matching activity and keep the reflection tied to medicine.
- `Service with People from Different Backgrounds`: select the strongest matching activity and keep the reflection tied to medicine.
- `Withdrawals or Breaks`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
