...
= The Ohio State University College of Medicine - Prompt 06

#section_label("Prompt metadata")
- Title: Community Training Interest
- Limit: 250 words
- Cycle used in this repo: 2024 archive on Admit.org search snippet
- Source: https://med.admit.org/secondary-essays/ohio-state-university-college-of-medicine
- Local notes file: prompt-06.local.md

#section_label("Prompt text")
Community Medicine Track: Why are you interested in training in a smaller community, and what is the impact you hope to have by training in this setting?
...
Read `../research.md` and `prompt-06.local.md` before drafting a final version.
