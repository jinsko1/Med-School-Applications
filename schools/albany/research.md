# Albany Medical College Research Notes
...
## Prompt Strategy
- `Describe Yourself`: select the strongest matching activity and keep the reflection tied to medicine.
- `Academic Inconsistencies`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
- `Interrupted Attendance or Gaps`: give a concise timeline of research, clinical work, service, and application-year responsibilities.
- `Significant Challenge`: use a concrete moment of humility, then show the behavioral adjustment you made afterward.
- `Structural and Social Determinants of Health`: lead with Restorative Partners, menstrual-product advocacy, hospice, or UTI/women's-health research depending on the wording.
- `Community Identity`: select the strongest matching activity and keep the reflection tied to medicine.
- `Anything Else`: select the strongest matching activity and keep the reflection tied to medicine.
- `Most Meaningful Activity Impact`: select the strongest matching activity and keep the reflection tied to medicine.
