# Thomas F. Frist, Jr. College of Medicine at Belmont University Research Notes
...
## Prompt Strategy
- `Most Energizing Belmont Value`: choose one close-contact story and focus on what changed in your behavior rather than making a broad diversity claim.
- `Spiritual Experiences, Faith, or Personal Beliefs`: select the strongest matching activity and keep the reflection tied to medicine.
- `Embracing Ambiguity in a New Community`: use a concrete moment of humility, then show the behavioral adjustment you made afterward.
- `Reapplicant Changes`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
