...
= Wake Forest University School of Medicine - Prompt 04
...
Please share an experience that demonstrates how you have collaborated with others.

#section_label("Shared backbone files")
- typst/shared/teamwork.typ

#section_label("teamwork backbone")
= Teamwork Backbone
