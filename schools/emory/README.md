...
- Prompt source: https://med.admit.org/secondary-essays/emory-university-school-of-medicine
...
- Short limits; concise storytelling matters more than background exposition.
...
- `schools/emory/essays/prompt-02.draft.md`
- `schools/emory/essays/prompt-03-why-emory.md`
- `schools/emory/essays/prompt-03.draft.md`
- `schools/emory/essays/prompt-04-service-to-underserved-communities.md`
