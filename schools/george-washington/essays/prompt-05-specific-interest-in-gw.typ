...
= George Washington University School of Medicine & Health Sciences - Prompt 05
...
- Source: https://medschoolinsiders.com/medical-school-secondary-prompts-database/george-washington-secondary-essay-prompts/
- Local notes file: prompt-05.local.md

#section_label("Prompt text")
What is your specific interest in the MD Program at GW? What opportunities would you take advantage of as a student here? Why?

#section_label("Shared backbone files")
- typst/shared/why-school.typ
- typst/shared/mission-fit.typ

#section_label("why-school backbone")
...
#section_label("mission-fit backbone")
...
Read `../research.md` and `prompt-05.local.md` before drafting a final version.
