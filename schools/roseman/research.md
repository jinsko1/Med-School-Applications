# Roseman University College of Medicine Research Notes
...
## Prompt Strategy
- `Obstacles on the Journey to Medicine`: select the strongest matching activity and keep the reflection tied to medicine.
- `Social Determinants of Health in Future Practice`: lead with Restorative Partners, menstrual-product advocacy, hospice, or UTI/women's-health research depending on the wording.
- `Cross-Cultural Interaction`: choose one close-contact story and focus on what changed in your behavior rather than making a broad diversity claim.
- `Gap Time Explanation`: give a concise timeline of research, clinical work, service, and application-year responsibilities.
- `Application Updates`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
