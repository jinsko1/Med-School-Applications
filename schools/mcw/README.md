...
- Prompt source: https://secondaryapplication.mcw.edu/Security/Login.aspx
...
- Updated from the applicant's MCW secondary portal. Live set has four required prompts and no reapplicant prompt in the pasted text.
...
- `schools/mcw/essays/prompt-02.draft.md`
- `schools/mcw/essays/prompt-03-decision-you-regret.md`
- `schools/mcw/essays/prompt-03.draft.md`
- `schools/mcw/essays/prompt-04-new-environment-and-community-engagement.md`
- `schools/mcw/essays/prompt-04.draft.md`
