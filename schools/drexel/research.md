# Drexel University College of Medicine Research Notes
...
## Prompt Strategy
- `Current and Recent Activities`: give a concise timeline of research, clinical work, service, and application-year responsibilities.
- `Why Drexel and Mission Fit`: tie the school mission to your research-service throughline, then add two named programs or clinical/community sites before submission.
- `Extenuating Circumstances`: answer directly and factually; avoid overexplaining unless there is a real issue to contextualize.
