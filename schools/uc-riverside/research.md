# University of California, Riverside School of Medicine Research Notes
...
## Prompt Strategy
- `Mission Fit and Class Contribution`: tie the school mission to your research-service throughline, then add two named programs or clinical/community sites before submission.
- `School Value in Practice`: select the strongest matching activity and keep the reflection tied to medicine.
- `Future Healthcare Setting`: select the strongest matching activity and keep the reflection tied to medicine.
- `Personal Challenge, Resilience, and Grit`: use a concrete moment of humility, then show the behavioral adjustment you made afterward.
