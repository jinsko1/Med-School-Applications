...
= Rush Medical College at Rush University - Prompt 04
...
- Source: https://medschoolinsiders.com/medical-school-secondary-prompts-database/rush-medical-college-secondary-essay-prompts/
- Local notes file: prompt-04.local.md

#section_label("Prompt text")
Can you describe a time when you recognized your privilege and used it to promote health equity? Please share specific initiatives, projects, or actions in which you were involved in and the impact they had. Optional.

#section_label("Shared backbone files")
- typst/shared/service.typ
- typst/shared/diversity-equity.typ

#section_label("service backbone")
...
Read `../research.md` and `prompt-04.local.md` before drafting a final version.
